...
#define EVENT_MANAGER()                                                                                                \
	kogayonon_core::RegistryManager::getInstance().getContext<std::shared_ptr<kogayonon_core::EventManager>>()
#define TASK_MANAGER()                                                                                                 \
	kogayonon_core::RegistryManager::getInstance().getContext<std::shared_ptr<kogayonon_utilities::TaskManager>>()
#define IMGUI_MANAGER()                                                                                                \
	kogayonon_core::RegistryManager::getInstance().getContext<std::shared_ptr<kogayonon_gui::ImGuiManager>>()
#define SHADER_MANAGER()                                                                                               \
	kogayonon_core::RegistryManager::getInstance().getContext<std::shared_ptr<kogayonon_utilities::ShaderManager>>()
