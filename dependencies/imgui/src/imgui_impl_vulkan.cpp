...
//  2025-05-07: Vulkan: Fixed validation errors during wd detach in multi-viewport mode. (#8600, #8176)
...
bool    ImGui_ImplVulkan_Init(ImGui_ImplVulkan_InitInfo* info)
{
    ...
    // Our render function expect RendererUserData to be storing the wd render buffer we need (for the main viewport we won't use ->Window)
...
static void ImGui_ImplVulkan_CreateWindow(ImGuiViewport* viewport)
{
    ...
    // Select Present Mode
    // FIXME-VULKAN: Even thought mailbox seems to get us maximum framerate with a single wd, it halves framerate with a second wd etc. (w/ Nvidia and SDK 1.82.1)
    ...
    //printf("[vulkan] Secondary wd selected PresentMode = %d\n", wd->PresentMode);
