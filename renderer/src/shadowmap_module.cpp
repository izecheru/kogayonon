    ...
    m_graph->addNode(
        ...
        [=]( VkCommandBuffer cmdBuffer ) {
            ...
            glm::mat4 lightProjection = glm::ortho(
                -10.0f, 10.0f, -10.0f, 10.0f, directionalLightComp.nearPlane, directionalLightComp.farPlane );

            glm::mat4 lightView = glm::lookAt(
                glm::vec3( -2.0f, 4.0f, -1.0f ), glm::vec3( 0.0f, 0.0f, 0.0f ), glm::vec3( 0.0f, 1.0f, 0.0f ) );
