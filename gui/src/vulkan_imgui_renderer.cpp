...
void gui::VulkanImguiRenderer::setupDockspace( ImGuiViewport* viewport )
{
    ...
    if ( static auto firstTime = true; firstTime ) [[unlikely]]
    {
        ...
        ImGuiID bottomNodeId =
            ImGui::DockBuilderSplitNode( centerNodeId, ImGuiDir_Down, 0.30f, nullptr, &centerNodeId );
        ImGuiID leftNodeId = ImGui::DockBuilderSplitNode( centerNodeId, ImGuiDir_Left, 0.20f, nullptr, &centerNodeId );
        ImGuiID rightNodeId =
            ImGui::DockBuilderSplitNode( centerNodeId, ImGuiDir_Right, 0.30f, nullptr, &centerNodeId );
                                          ...
                                          graphics::VulkanSwapchain* swapchain )
{
    ...
    m_fonts.emplace(
        "inter", io.Fonts->AddFontFromFileTTF( "engine_resources/fonts/Inter_18pt-Medium.ttf", baseFontSize, &cfg ) );
...
void gui::VulkanImguiRenderer::initWindows()
{
    ...
    auto folder = ImGui_ImplVulkan_AddTexture(
        m_iconSampler, folderTexture->getView(), VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL );
...
void gui::VulkanImguiRenderer::colorChanger()
{
    ...
    ImGui::ColorEdit4(
        "Frame bg hovered", (float*)&style.Colors[ImGuiCol_FrameBgHovered], ImGuiColorEditFlags_NoInputs );
    ...
    ImGui::ColorEdit4(
        "Text selectable", (float*)&style.Colors[ImGuiCol_TextSelectedBg], ImGuiColorEditFlags_NoInputs );
...
void gui::VulkanImguiRenderer::configModal()
{
    ...
    gui_utils::centerPopup( { static_cast<float>( w ), static_cast<float>( h ) }, { 600.0f, 600.0f } );
    if ( ImGui::BeginPopupModal( "Engine config",
                                 nullptr,
...
auto gui::VulkanImguiRenderer::setColorPallete( const utilities::ColorConfig& cfg ) -> void
{
    ...
    style.Colors[ImGuiCol_TabHovered] = { cfg.ImGuiCol_TabHovered.r,
                                          cfg.ImGuiCol_TabHovered.g,
                                          cfg.ImGuiCol_TabHovered.b,
                                          cfg.ImGuiCol_TabHovered.alpha };
    ...
    style.Colors[ImGuiCol_SliderGrab] = { cfg.ImGuiCol_SliderGrab.r,
                                          cfg.ImGuiCol_SliderGrab.g,
                                          cfg.ImGuiCol_SliderGrab.b,
                                          cfg.ImGuiCol_SliderGrab.alpha };
    ...
    style.Colors[ImGuiCol_ResizeGrip] = { cfg.ImGuiCol_ResizeGrip.r,
                                          cfg.ImGuiCol_ResizeGrip.g,
                                          cfg.ImGuiCol_ResizeGrip.b,
                                          cfg.ImGuiCol_ResizeGrip.alpha };
...
auto gui::VulkanImguiRenderer::deviceModal() -> void
{
    ...
    gui_utils::centerPopup( { static_cast<float>( w ), static_cast<float>( h ) }, { 600.0f, 600.0f } );
    if ( ImGui::BeginPopupModal( "GPU properties",
                                 nullptr,
                                 ImGuiWindowFlags_NoDocking | ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoResize ) )
    {
