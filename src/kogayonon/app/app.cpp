...
namespace kogayonon
{
  ...
  void App::run() {
    ...
    { glm::vec3(0.5f, 0.0f, 0.5f), glm::vec3(1.0f, 0.0f, 0.0f) }, // Red
    { glm::vec3(0.5f, 0.0f, -0.5f), glm::vec3(0.0f, 1.0f, 0.0f) }, // Green
    { glm::vec3(1.5f, 0.0f, -0.5f), glm::vec3(0.0f, 0.0f, 1.0f) }, // Blue
    { glm::vec3(1.5f, 0.0f, 0.5f), glm::vec3(1.0f, 0.0f, 0.0f) }, // Red
    { glm::vec3(1.0f, 0.8f, 0.0f), glm::vec3(1.0f, 1.0f, 0.0f) }  // Yellow
    };
